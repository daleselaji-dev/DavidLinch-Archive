...
def build_mid(fine=False):
    ...
    body_mat = make_material(
        'wraithBody', (0.006, 0.004, 0.010, 1), roughness=0.96,
        sheen=0.25, emission=(0.06, 0.006, 0.025, 1), emission_strength=0.04)
...
def build_fine():
    ...
    hair_mat = make_material(
        'wraithHair', (0.004, 0.003, 0.008, 1), roughness=0.86,
        sheen=0.25, emission=(0.012, 0.010, 0.028, 1), emission_strength=0.035)
