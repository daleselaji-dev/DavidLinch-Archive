...
| 文件 | 说明 |
|------|------|
| `release/SmokeVelvet-LynchArchive-Portable-1.8.0.exe` | **便携版**：双击即运行，免安装（推荐分发；含 v1.8 Blender 权威细模三资产/七厅彩蛋讲解扩容） |
| `release/SmokeVelvet-LynchArchive-Portable-1.7.0.exe` | 上一版便携版 |
