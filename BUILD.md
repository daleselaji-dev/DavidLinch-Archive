...
| 文件 | 说明 |
|------|------|
| `release/SmokeVelvet-LynchArchive-Portable-1.9.0.exe` | **便携版**：双击即运行，免安装（推荐分发；含 v1.9 Blender 细模第二批/连锁彩蛋/深夜电台/diner 光害治理） |
| `release/SmokeVelvet-LynchArchive-Portable-1.8.0.exe` | 上一版便携版 |
