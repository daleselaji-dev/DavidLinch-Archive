...
| 文件 | 说明 |
|------|------|
| `release/SmokeVelvet-LynchArchive-Portable-1.10.0.exe` | **便携版**：双击即运行，免安装（推荐分发；含 v1.10 Blender 细模第三批·夜鸮/点唱机、守夜/罐壁连锁彩蛋、缩微阅读器与讲解扩容） |
| `release/SmokeVelvet-LynchArchive-Portable-1.9.0.exe` | 上一版便携版 |
